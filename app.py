...
with col2:
    if 'Profit' in df.columns:
        ...
        st.warning("❗ 'Profit' column not found.")
...
with col4:
    if 'PaymentMode' in df.columns:
        ...
        st.warning("❗ 'PaymentMode' column not found.")
...
with col1:
    if {'Category', 'Quantity'}.issubset(df.columns):
        ...
        st.warning("❗ 'Category' or 'Quantity' column not found.")

with col2:
    if {'PaymentMode', 'Quantity'}.issubset(df.columns):
        ...
        st.warning("❗ 'PaymentMode' or 'Quantity' column not found.")
...
if {'Sub-Category', 'Profit'}.issubset(df.columns):
    ...
    st.warning("❗ 'Sub-Category' or 'Profit' column not found.")

# Monthly Profit
if {'Date', 'Profit'}.issubset(df.columns):
    ...
    st.warning("❗ 'Date' or 'Profit' column not found.")
